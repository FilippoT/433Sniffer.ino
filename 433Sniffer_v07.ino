...
//    ( )( )   /'_  ) /'_  )(  _`\         _  /'___)/'___)               _               
//    | || |  (_)_) |(_)_) || (_(_)  ___  (_)| (__ | (__   __   _ __    (_)  ___     _   
//    | || |_  _(_ <  _(_ < `\__ \ /' _ `\| || ,__)| ,__)/'__`\( '__)   | |/' _ `\ /'_`\ 
//    (__ ,__)( )_) |( )_) |( )_) || ( ) || || |   | |  (  ___/| |    _ | || ( ) |( (_) )
//       (_)  `\____)`\____)`\____)(_) (_)(_)(_)   (_)  `\____)(_)   (_)(_)(_) (_)`\___/'
                                                                                                                                                                      

// 433Sniffer.ino v0.7 Beta
...
void rx() {
  ...
  CheckSendCodeButton();  // Controlla se pulsante "SendCode" è stato premuto, quando catturato un codice
}
...
void CheckJammerButton() {
  if (digitalRead(JammerMode) == HIGH) {  // Controlla se pulsante "JammerMode" è stato premuto
    jammer();
  }
}

void CheckSendCodeButton() {
  if (digitalRead(SendCode) == HIGH && digitalRead(CapturedLed) == HIGH) {  // Controllo del pulsante "SendCode" quando e' catturato un codice
    tx();
  }
